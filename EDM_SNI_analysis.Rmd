...
# png("plots/ccm_network.png",height=600,width=600)
plot(g2,asp=0.8, vertex.label.color="black",vertex.label.family="Times", vertex.label.cex=0.6, edge.arrow.size=0.8,edge.arrow.width=0.8,vertex.label.font=2, vertex.shape="circle", edge.curved=curves,margin=0,vertex.size=20,rescale=T,edge.lty=1,edge.color=edge.cols,layout=layout_in_circle,vertex.color=vert.cols,vertex.frame.color="black",main="")
# dev.off()
```
...
int_mean_sd <-spp.only.mod.coeffs %>%
  ...
  summarise(mean_int=mean(value,na.rm=T),abs_mean=abs(mean_int),sd_int=sd(value,na.rm=T),n=n(),
