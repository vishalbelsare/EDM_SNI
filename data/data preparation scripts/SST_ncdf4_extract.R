...
# Much code from Luke Miller, but modified to be much simpler and smaller in scope
...
for(i in 1981:2014) {
  fname <- paste0(WD,"/data/raw/ncdf sst/sst.day.mean.",i,".nc")
...
rm(fname,i,WD,extr_ncdf_SNI,temp,sst.dat.all)