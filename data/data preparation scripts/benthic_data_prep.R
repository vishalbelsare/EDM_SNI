...
# This function takes the raw benthic density and benthic cover data, edits the species names, 
...
spp.key <- read_csv('data/raw/Table4_Species_sampled.csv',col_types = cols()) %>% 
...
##### Load, filter, and normalized the data ####
